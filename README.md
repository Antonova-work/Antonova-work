...
Я студентка 2-го курса, изучаю Backend-разработку, Алгоритмы и Machine Learning. В этом профиле я собираю свои проекты, лабораторные работы и личную базу знаний.
...
### 🤖 [Machine Learning](https://github.com/Antonova-work/practicum-semester-2)
